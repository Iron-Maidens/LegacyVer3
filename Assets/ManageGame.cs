...
public class ManageGame : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        itemDescription[1] = "น้ำเป็นสิ่งที่โปร่งใส ไม่มีรส ไม่มีกลิ่น และเกือบจะไม่มีสี ซึ่งเป็นสารเคมีที่เป็นองค์ประกอบหลักของลำธาร, แม่น้ำ, และมหาสมุทรในโลก เป็นต้น  น้ำดื่มสะอาดเป็นสิ่งจำเป็นสำหรับมนุษย์และสิ่งมีชีวิตอื่นๆ";
        itemDescription[2] = "หญ้าเป็นพืชล้มลุกชนิดหนึ่ง ซึ่งมีบทบาทสำคัญในหลากหลยด้าน เช่น นำมาใช้เพาะปลูก เลี้ยงสัตว์ และยังสามารถนำมาใช้ผลิตพลังงานทดแทน";
        ...
        itemDescription[12] = "ต้นไม้คือสิ่งมีชีวิตในธรรมชาติที่สามารถสังเคราะห์อาหารเพื่อตัวเอง ด้วยวิธีการดูดซับพลังงานจากดวงอาทิตย์และธาตุอาหารจากปัจจัยแวดล้อม ต้นไม้เป็นส่วนประกอบสำคัญของภูมิประเทศตามธรรมชาติ เนื่องจากมันสามารถป้องกันภูมิประเทศจากการกัดเซาะ และเป็นส่วนสำคัญของการปรับภูมิทัศน์และการเกษตร เนื้อไม้จากต้นไม้เป็นวัสดุที่ใช้ทั่วไปในการก่อสร้างเช่นทำผนังและโครงสร้าง";
        itemDescription[13] = "รวงข้าว หมายถึง ช่อดอกของข้าว (inflorescence) ซึ่งเกิดขึ้นที่ข้อของปล้องอันสุดท้าย ของต้นข้าว รวงข้าวจะถูกเก็บเกี่ยวเมื่อถึงฤดูการเก็บเกี่ยวข้าว";
        ...
        itemDescription[16] = "ข้าวสารเหนียวเป็นข้าวที่มีลักษณ์เด่นคือการติดกันเหมือนกาวของเมล็ดข้าวที่สุกแล้ว ได้รับความนิยมในการบริโภคอย่างกว้างขวาง ปลูกมากทางภาคตะวันออกเฉียงเหนือของประเทศไทยและประเทศลาว";
        itemDescription[17] = "ครกสีข้าวเป็นภูมิปัญญาท้องถิ่นของไทยในการสีข้าว  โดยใช้วัสดุที่ประกอบด้วย ไม้ไผ่แก่จัดผ่าเป็นซี่บาง ๆ ดินเหนียว เกลือ น้ำมันยาง ไม้ส้าน หรือไม้โกงกาง สีด้วยการโยกจากแรงงานคน บางพื้นที่ก็ใช้แรงงานสัตว์เช่นวัวและควาย โดยให้เดินไปรอบ ๆ ครกลาดคัดครกเพื่อให้ครกหมุนสีข้าวเปลือก";
        itemDescription[18] = "มีดคือเครื่องมือชนิดแรกๆที่มนุษย์ประดิษฐ์ขึ้นมาเพื่อใช้ในชีวิตประจำวันอย่างยาวนาน มีดเป็นเครื่องมือตัดเฉือนชนิดมีคมสำหรับใช้ สับ หั่น เฉือน ปาด ที่เกี่ยวข้องสัมพันธ์กับแทบทุกกิจกรรมในการดำเนินชีวิต";
        ...
        itemDescription[20] = "ไผ่เป็นไม้พุ่มชนิดหนึ่ง ผลผลิตจากไผ่ที่สำคัญคือ หน่อไม้ ซึ่งเป็นอาหารสำคัญของคนไทย นอกจากนี้ไผ่ยังมีคุณสมบัติทั้งทางด้านความแข็งแรงและความยืดหยุ่น จึงนิยมในการทำเครื่องมือเครื่องใช้หลายประเภท การก่อสร้าง";
        itemDescription[21] = "ไม้ไผ่เป็นสิ่งที่ได้มาจากต้นไผ่สามารถนำมาทำประโยชน์ด้านหลากหลาย เช่น นำมาทำผลิตภัณฑ์หัตถกรรมและอุตสาหกรรม ประโยชน์ทางด้านการบริโภค นำมาทำเป็นกระบอกไม้ไผ่ เป็นต้น";
        ...
        itemDescription[24] = "ทองคำเป็นธาตุกลุ่มโลหะชนิดหนึ่ง เป็นธาตุโลหะทรานซิชันสีเหลืองทองมันวาวเนื้ออ่อนนุ่ม สามารถยืดและตีเป็นแผ่นได้ ทองคำไม่ทำปฏิกิริยากับสารเคมีส่วนใหญ่ ทองคำใช้เป็นทุนสำรองทางการเงินของหลายประเทศ ใช้ประโยชน์เป็นเครื่องประดับ งานทันตกรรม และอุปกรณ์อิเล็กทรอนิกส์";
        ...
        itemDescription[28] = "ข้าวหลาม เป็นขนมชนิดหนึ่งนิยมทำรับประทานกันในฤดูหนาว หรือเมื่อได้ข้าวใหม่ ใช้ไผ่ข้าวหลาม หรือไม้ป้างเป็นกระบอกใส่ข้าวหลาม ข้าวหลามแบบชาวบ้าน ใช้ข้าวสารเหนียวกับน้ำเปล่า และเกลือเท่านั้น";
        ...
        itemDescription[31] = "เนื้อโค หรือ เนื้อวัว หมายถึง อวัยวะกล้ามเนื้อ จัดว่าเป็นแหล่งของสารอาหารโปรตีนที่มีคุณภาพดีมาเป็นเวลาช้านาน โปรตีนในเนื้อวัวเป็นโปรตีนที่มีค่าทางชีวภาพสูง (high biological value)";
        itemDescription[32] = "เกลือเป็นแร่ธาตุส่วนใหญ่ประกอบด้วยโซเดียมคลอไรด์ (NaCl) เกลือผลิตจากเหมืองเกลือหรือการระเหยน้ำทะเล เกลือจำเป็นต่อชีวิตสัตว์ ความเค็มเป็นรสชาติพื้นฐานของสิ่งมีชีวิตเกลือเป็นเครื่องปรุงรสที่มีที่เก่าแก่ที่สุดและหาง่ายที่สุด";
        ...
        itemDescription[37] = "ขิง เป็นพืชล้มลุก มีเหง้าใต้ดิน เปลือกนอกสีน้ำตาลแกมเหลือง เนื้อในสีนวลมีกลิ่นหอมเฉพาะ ในทางยานิยมใช้ขิงแก่ เพราะขิงยิ่งแก่จะยิ่งเผ็ดร้อนและมีใยอาหารมาก ขิงนำมาทำอาหารได้หลากหลาย ขิงอ่อนใช้เป็นผักจิ้ม ใช้ทำผัดขิง ใส่ในยำ";
        itemDescription[38] = "พริกเป็นเครื่องเทศที่สำคัญชนิดหนึ่ง มีคุณสมบัติเป็นยาสมุนไพรด้วย พริกมีวิตามินซี สูง เป็นแหล่งของกรด ascorbic ซึ่งสารเหล่านี้ ช่วยขยายเส้นโลหิตในลำไส้และกระเพาะอาหารเพื่อให้ดูดซึมอาหารดีขึ้น ช่วยร่างกายขับถ่าย ของเสียและนำธาตุอาหารไปยังเนื้อเยื่อของร่างกาย";
        ...
        itemDescription[41] = "ขมิ้นเป็นพืชล้มลุกในวงศ์ขิง มีถิ่นกำเนิดในเอเชียตะวันออกเฉียงใต้ มีเหง้าอยู่ใต้ดิน เนื้อในของเหง้าเป็นสีเหลือง มีกลิ่นหอมเฉพาะตัว มีสีเหลือง ขมิ้นมีฤทธิ์ในการฆ่าเชื้อ บรรเทาอาการปวดท้อง ท้องอืด แน่นจุกเสียด แก้โรคผิวหนัง ขับลม แก้ผื่นคัน ท้องร่วง";
