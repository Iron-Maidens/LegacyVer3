...
public class ManageGame : MonoBehaviour
{
    ...
    void Start()
    {
      //  for (int i = 0; i < 20; i++) chkEventList[i] = 1;
        ...
        itemDescription[9] = "ทุ่งนาเป็นบริเวณที่นาที่มีการเพาะ\nปลูกข้าว";
        ...
        itemDescription[43] = "ปลาร้าเป็นอาหารท้องถิ่นที่สำคัญในเอเชียตะวันออกเฉียงใต้ โดยแต่ละท้องถิ่นจะมีการทำปลาร้าเป็นเอกลักษณ์ของตน";
        ...
        itemDescription[53] = "ปลาร้าเป็นอาหารท้องถิ่นที่สำคัญในเอเชียตะวันออกเฉียงใต้ โดยแต่ละท้องถิ่นจะมีการทำปลาร้าเป็นเอกลักษณ์ของตน";
